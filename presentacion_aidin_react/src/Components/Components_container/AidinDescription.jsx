import "./ComponentsContainerStyles/DescriptionStyles.css"
import "./ComponentsContainerStyles/CommonComponentsStyles.css"

export const AidinDescription = () => {

    return (
        <>
            <div className="container">
                <div className="aidin_name_container">
                    <h1 className="aidin_name">Aidin Rodriguez</h1>
                    <br className="divisor_line" />
...
export default AidinDescription
